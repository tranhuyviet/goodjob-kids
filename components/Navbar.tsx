...
const Navbar = () => {
    ...
    return (
        <nav className="h-[68px] container flex justify-between items-center bg-gray-100 shadow-md">
            ...
            <div>
                <p className="text-red-400 text-xl flex items-center"> <Image src="/images/hello.png" width={38} height={38} alt="mop" /><span className=" tracking-wider uppercase text-red-400 ml-2">{user.name}</span></p>            </div>
        </nav>
    )
}
